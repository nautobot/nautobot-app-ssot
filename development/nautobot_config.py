...
PLUGINS_CONFIG = {
    ...
    "nautobot_ssot": {
        ...
        "enable_panorama": is_truthy(os.getenv("NAUTOBOT_SSOT_ENABLE_PANORAMA")),
        ...
        "panorama_firewall_manufacturer_name": os.getenv("NAUTOBOT_SSOT_PANORAMA_FIREWALL_MANUFACTURER_NAME", "Palo Alto"),
        "panorama_firewall_platform_name": os.getenv("NAUTOBOT_SSOT_PANORAMA_FIREWALL_PLATFORM_NAME", "paloalto_panos"),
        "panorama_firewall_role_name": os.getenv("NAUTOBOT_SSOT_PANORAMA_FIREWALL_ROLE_NAME", "Firewall"),
