...
def docker_compose(context, command, **kwargs):
    ...
    if context.nautobot_ssot.ephemeral_ports and context.nautobot_ssot.compose_files == ORIGINAL_COMPOSE_FILES:
        compose_file_path = os.path.join(context.nautobot_ssot.compose_dir, "docker-compose.ephemeral-ports.yml")
        compose_command_tokens.append(f' -f "{compose_file_path}"')
