...
- [#1017](https://github.com/nautobot/nautobot-app-ssot/issues/1017) - Updated Device42 integration to use SoftwareVersion in core Nautobot over SoftwareLCM from Device Lifecycle Management App.
