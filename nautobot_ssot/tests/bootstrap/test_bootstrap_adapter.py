...
class TestBootstrapAdapterTestCase(TransactionTestCase):
    ...
    def setUp(self):
        ...
        self.bootstrap_client.get_global_settings.return_value = GLOBAL_SETTINGS
        self.bootstrap_client.get_develop_settings.return_value = DEVELOP_SETTINGS
        self.bootstrap_client.get_production_settings.return_value = PRODUCTION_SETTINGS
