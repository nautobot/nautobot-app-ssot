...
```
from nautobot_ssot.tests.openshift.openshift_fixtures import json_fixture
from nautobot_ssot.tests.openshift.openshift_fixtures import real_path
```
...
from .nautobot_fixtures import (
    LOCALHOST,
    create_default_openshift_config,
