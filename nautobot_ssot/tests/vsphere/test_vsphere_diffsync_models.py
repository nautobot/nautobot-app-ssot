...
class TestVSphereDiffSyncModelsCreate(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.nb_adapter = Adapter(config=self.config)
    ...
    def test_clustergroup_creation(self):
        ...
        self.vsphere_adapter.sync_to(self.nb_adapter)
...
# class TestVSphereDiffSyncModelsDelete(unittest.TestCase):
...
#         with self.assertRaises(ClusterGroup.DoesNotExist):
#             ClusterGroup.objects.get(name="TestClusterGroup")
...
#             Cluster.objects.get(name="TestCluster")
