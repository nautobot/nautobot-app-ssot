...
class NautobotSSOTAppConfig(NautobotAppConfig):
    ...
    default_settings = {
        ...
        # When False, the Proxmox integration does not auto-create its default Secrets, SecretsGroup,
        # ExternalIntegration, or SSOTProxmoxConfig (for operators who manage those objects themselves).
