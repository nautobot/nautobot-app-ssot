...
class IpFabricDataSource(DataSource):  # pylint: disable=too-many-instance-attributes
    ...
    def run(self, *args, **kwargs):
        ...
        self.safe_delete_mode = kwargs.get("safe_delete_mode")
        self.sync_ipfabric_tagged_only = kwargs.get("sync_ipfabric_tagged_only")
        self.location_filter = kwargs.get("location_filter")
        ...
        self.kwargs = {
            ...
            "dryrun": self.dryrun,
            "safe_delete_mode": self.safe_delete_mode,
            "sync_ipfabric_tagged_only": self.sync_ipfabric_tagged_only,
