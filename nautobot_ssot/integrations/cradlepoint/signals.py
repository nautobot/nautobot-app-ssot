...
def create_default_location(sender, *, apps, **kwargs):  # pylint: disable=unused-argument
    ...
    default_parent_location_name = config.get("cradlepoint_default_parent_location_name")
    default_parent_location_type = config.get("cradlepoint_default_parent_location_type")
    ...
    try:
        ...
        print(f"Error creating parent location: {err}")
        return
