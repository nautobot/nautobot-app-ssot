...
class BootstrapAdapter(Adapter, LabelMixin):
    ...
    def load(self):
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["tenant_group"]:
            if global_settings.get("tenant_group") and global_settings["tenant_group"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["tenant"]:
            if global_settings.get("tenant") and global_settings["tenant"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["role"]:
            if global_settings.get("role") and global_settings["role"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["manufacturer"]:
            if global_settings.get("manufacturer") and global_settings["manufacturer"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["platform"]:
            if global_settings.get("platform") and global_settings["platform"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["location_type"]:
            if global_settings.get("location_type") and global_settings["location_type"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["location"]:
            if global_settings.get("location") and global_settings["location"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["team"]:
            if global_settings.get("team") and global_settings["team"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["contact"]:
            if global_settings.get("contact") and global_settings["contact"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["provider"]:
            if global_settings.get("provider") and global_settings["provider"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["provider_network"]:
            if global_settings.get("provider_network") and global_settings["provider_network"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["circuit_type"]:
            if global_settings.get("circuit_type") and global_settings["circuit_type"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["circuit"]:
            if global_settings.get("circuit") and global_settings["circuit"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["circuit_termination"]:
            if global_settings.get("circuit_termination") and global_settings["circuit_termination"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["namespace"]:
            if global_settings.get("namespace") and global_settings["namespace"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["rir"]:
            if global_settings.get("rir") and global_settings["rir"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["vlan_group"]:
            if global_settings.get("vlan_group") and global_settings["vlan_group"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["vlan"]:
            if global_settings.get("vlan") and global_settings["vlan"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["vrf"]:
            if global_settings.get("vrf") and global_settings["vrf"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["prefix"]:
            if global_settings.get("prefix") and global_settings["prefix"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["secret"]:
            if global_settings.get("secret") and global_settings["secret"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["secrets_group"]:
            if global_settings.get("secrets_group") and global_settings["secrets_group"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["git_repository"]:
            if global_settings.get("git_repository") and global_settings["git_repository"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["dynamic_group"]:
            if global_settings.get("dynamic_group") and global_settings["dynamic_group"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["computed_field"]:
            if global_settings.get("computed_field") and global_settings["computed_field"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["custom_field"]:
            if global_settings.get("custom_field") and global_settings["custom_field"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["tag"]:
            if global_settings.get("tag") and global_settings["tag"] is not None:  # noqa: F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["graph_ql_query"]:
            if global_settings.get("graph_ql_query") and global_settings["graph_ql_query"] is not None:  # noqa F821
        ...
        if settings.PLUGINS_CONFIG["nautobot_ssot"]["bootstrap_models_to_sync"]["scheduled_job"]:
            if global_settings.get("scheduled_job") and global_settings["scheduled_job"] is not None:  # noqa F821
